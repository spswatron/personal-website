(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [3],
  {
                      ...
                      for (;;)
                        switch ((n.prev = n.next)) {
                          ...
                          case 13:
                            return (
                              (g = n.sent),
                              (_ = Object.assign({ styles: y }, g)),
                              n.abrupt("return", "error" in g ? g : _)
                            );
                          case 18:
                            return (
                              (n.prev = 18),
    ...
    elyg: function (e, t, r) {
            ...
            return (
              ...
              (u || e in i) &&
                (n =
                  n.replace(
                    s,
                    o ? t.map(p.default).join("/") : (0, p.default)(t)
                  ) || "/")
            );
          }) || (n = ""),
          { params: u, result: n }
      ...
      function L(e, t, r) {
        return { url: x(O(e.pathname, t)), as: r ? x(O(e.pathname, r)) : r };
      }
          ...
          i(this, e),
            ...
            (this.onPopState = function (e) {
              ...
              if (t) {
                ...
                a.changeState(
                  "replaceState",
                  (0, h.formatWithValidation)({ pathname: x(u), query: s }),
                  (0, h.getURL)()
                );
              }
            }),
            ...
            "//" !== n.substr(0, 2) &&
              this.changeState(
                "replaceState",
                (0, h.formatWithValidation)({ pathname: x(t), query: r }),
                (0, h.getURL)(),
                { locale: _ }
              ),
        ...
        return (
          u(e, [
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 38:
                              (I = t.sent), I.__rewrites, (t.next = 46);
                              break;
                            case 42:
                              return (
                                (t.prev = 42),
                            ...
                            case 46:
                              if (
                                ((m = this._resolveHref(m, j)).pathname !== b &&
                                  ((b = m.pathname),
                                  (n = (0, h.formatWithValidation)(m))),
                                (b = b
                                  ? (0, s.removePathTrailingSlash)(k(b))
                                  : b),
                                this.urlIsNew(p) || u || (r = "replaceState"),
                                (M = (0, s.removePathTrailingSlash)(b)),
                                (D = P(k((D = a)), this.locale)),
                                !(0, d.isDynamicRoute)(M))
                              ) {
                                t.next = 69;
                                break;
                              }
                              if (
                                ((T = (0, v.parseRelativeUrl)(D)),
                                (A = T.pathname),
                                (U = (0, g.getRouteRegex)(M)),
                                (N = (0, y.getRouteMatcher)(U)(A)),
                                (q = (W = M === A) ? E(M, A, O) : {}),
                                N && (!W || q.result))
                              ) {
                                t.next = 68;
                              ...
                              if (
                                !(
                                  (F = Object.keys(U.groups).filter(function (
                                    e
                                  ) {
                                    return !O[e];
                                  })).length > 0
                            ...
                            case 69:
                              return (
                                e.events.emit("routeChangeStart", a, f),
                                (t.prev = 70),
                                (t.next = 73),
                                this.getRouteInfo(M, b, O, a, f)
                              );
                            case 73:
                              if (
                                ((B = t.sent),
                              ...
                              if (
                                !(J = G.pageProps.__N_REDIRECT).startsWith("/")
                              ) {
                                t.next = 83;
                                break;
                              }
                              if (
                                ((X = (0, v.parseRelativeUrl)(J)),
                                this._resolveHref(X, j, !1),
                                !j.includes(X.pathname))
                              ) {
                                t.next = 83;
                                break;
                              }
                              return (
                                ...
                                ($ = Y.url),
                                (Q = Y.as),
                                t.abrupt("return", this.change(r, $, Q, i))
                              );
                            case 83:
                              return (
                            ...
                            case 85:
                              return (
                                ...
                                this.changeState(r, n, a, i),
                                (t.next = 90),
                                this.set(M, b, O, p, B).catch(function (e) {
                            ...
                            case 90:
                              ...
                              throw (
                                (e.events.emit("routeChangeError", H, p, f), H)
                              );
                            case 93:
                              return (
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 27:
                              return (
                                ...
                                e.abrupt(
                                  "return",
                                  this.handleRouteInfoError(e.t1, r, n, a, i)
                                )
                              );
                            case 30:
                            case "end":
                    ...
                    (t.includes(o) ||
                      t.some(function (t) {
                        if (
                          ...
                          (0, g.getRouteRegex)(t).re.test(o)
                        )
                          return (e.pathname = r ? x(t) : t), !0;
                      }),
            ...
            },
            {
              ...
              value: function (t, r) {
                this.clc &&
                  (e.events.emit("routeChangeError", b(), t, r),
                  this.clc(),
                  (this.clc = null));
              },
            },
